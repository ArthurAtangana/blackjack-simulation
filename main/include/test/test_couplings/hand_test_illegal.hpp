...
class handTestIllegal: public cadmium::Coupled {
public:
handTestIllegal(const std::string& id) : Coupled(id) {
        // Create model instances
        auto handModel = addComponent<hand>("hand");
        auto mockModel = addComponent<lib::IEStream<Cards>>("hand input", "main/include/test/inputs/hand_inputs/hand_in_illegal.txt");
